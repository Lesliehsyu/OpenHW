...
YOLO V2 相对初代有两方面主要改进：一，作者对原来的 YOLO 多目标检测框架进行了改进，在保持原有速度的优势之下，精度上得以提升。二，作者提出了一种目标分类与检测的联合训练方法，训练后的模型可以实现对最多达 9000 种物体的实时检测，我们的设备可以识别 80 种不同的物体，但仅筛选出所识别到的人用于检测。
